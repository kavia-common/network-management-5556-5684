...
1) Create and configure environment variables
   ...
   - Default DB name is now 'network'. To keep using old data in 'network_devices', set MONGODB_DB_NAME=network_devices or include it in your URI.
   - For CORS, ensure FRONTEND_ORIGIN_ALLOWLIST or CORS_ALLOWED_ORIGINS includes your frontend origin(s). For this environment add:
